...
D4 User Journey : 
    ...
    4.
    Step 3: WANTS (ไลฟ์สไตล์หลังเกษียณ):
    ◦
    คำถาม: "คุณอยากใช้ชีวิตหลังเกษียณแบบไหน?"
    ◦
    Input: ผู้ใช้กรอก ค่าใช้จ่ายต่อเดือนในปัจจุบัน (เช่น 30,000 บาท)
    ◦
    การทำงาน: ระบบจะเก็บข้อมูลนี้ไว้เพื่อนำไปคำนวณหาค่าใช้จ่ายในอนาคต แล้วพาไปยังขั้นตอนต่อไป
